...
import 'package:netflix_redesign/view/movies/view/widget/special_item.dart';
...
class SpecialList extends StatelessWidget {
  ...
  SpecialList({Key? key, required this.current, required this.futureSpecialMovie, required this.carouselController}) : super(key: key);
